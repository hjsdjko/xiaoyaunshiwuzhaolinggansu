...
public class ShiwuzhaolingLiuyanView extends ShiwuzhaolingLiuyanEntity implements Serializable {
	...
	public ShiwuzhaolingLiuyanView() {

	}

	public ShiwuzhaolingLiuyanView(ShiwuzhaolingLiuyanEntity shiwuzhaolingLiuyanEntity) {
		try {
			BeanUtils.copyProperties(this, shiwuzhaolingLiuyanEntity);
