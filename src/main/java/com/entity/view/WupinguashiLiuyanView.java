...
public class WupinguashiLiuyanView extends WupinguashiLiuyanEntity implements Serializable {
    private static final long serialVersionUID = 1L;
		...
		//级联表 wupinguashi
			...
			* 寻物启事 的 用户
			*/
			private Integer wupinguashiYonghuId;
			/**
			* 丢失地址
			*/
		...
		try {
			...
			e.printStackTrace();
				...
				//级联表的get和set wupinguashi
					...
					* 获取：寻物启事 的 用户
					*/
					public Integer getWupinguashiYonghuId() {
						return wupinguashiYonghuId;
					}
					/**
					* 设置：寻物启事 的 用户
					*/
					public void setWupinguashiYonghuId(Integer wupinguashiYonghuId) {
						this.wupinguashiYonghuId = wupinguashiYonghuId;
					}
