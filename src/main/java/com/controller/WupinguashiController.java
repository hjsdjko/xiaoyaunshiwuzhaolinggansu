...
//                            wupinguashiEntity.setWupinguashiPhoto("");//详情和图片
//                            wupinguashiEntity.setWupinguashiTime(sdf.parse(data.get(0)));          //丢失时间 要改的
//                            wupinguashiEntity.setYonghuId(Integer.valueOf(data.get(0)));   //用户 要改的
//                            wupinguashiEntity.setWupinguashiDizhi(data.get(0));                    //丢失地址 要改的
//                            wupinguashiEntity.setWupinguashiContent("");//详情和图片
